<?php
	...
	class DB_mysql{	
		...
		function conectar($bd,$host,$user,$pass){
			...
			$this->Conexion_ID=mysql_connect($this->Servidor,$this->Usuario,$this->Clave);//conectamos al servidor
			if(!$this->Conexion_ID){
	...
	/*
	$mysql = new DB_mysql();
	$mysql->conectar("iqe_lex_inv_2010","localhost","root","xampp");
	$mysql->consulta("SELECT * FROM menu");
	echo "# registros: ".$mysql->numregistros();
	*/
?>