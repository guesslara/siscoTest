...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_fechain"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_fechain"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_fechain']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grafico_fechain']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_fechain']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grafico_fechain']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grafico_fechain']['sc_modal']);
