...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_fallas_tecnicas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_fallas_tecnicas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_fallas_tecnicas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grafico_fallas_tecnicas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_fallas_tecnicas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grafico_fallas_tecnicas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grafico_fallas_tecnicas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grafico_fallas_tecnicas</TITLE>
