...
class grafico_fallas_tecnicas_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grafico_fallas_tecnicas_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_grafico_fallas_tecnicas";
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grafico_fallas_tecnicas.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_fallas_tecnicas']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_fallas_tecnicas']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_fallas_tecnicas']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_fallas_tecnicas']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_fallas_tecnicas']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "reg_fallas_tecnicas_fecha" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "cat_fallas_tecnicas_descripcion" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tipoalmacen_almacen = $rs->fields[13] ;  
         $this->reg_fallas_tecnicas_fecha = $rs->fields[14] ;  
         $this->cat_fallas_tecnicas_descripcion = $rs->fields[15] ;  
   ...
   //----- reg_fallas_tecnicas_fecha
   function NM_export_reg_fallas_tecnicas_fecha()
   {
         $conteudo_x =  $this->reg_fallas_tecnicas_fecha;
         nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD");
         if (is_numeric($conteudo_x) && $conteudo_x > 0) 
         { 
             $this->nm_data->SetaData($this->reg_fallas_tecnicas_fecha, "YYYY-MM-DD");
             $this->reg_fallas_tecnicas_fecha = $this->nm_data->FormataSaida($this->Nm_date_format("DT", "ddmmaaaa"));
         } 
         if (!NM_is_utf8($this->reg_fallas_tecnicas_fecha))
         {
             $this->reg_fallas_tecnicas_fecha = mb_convert_encoding($this->reg_fallas_tecnicas_fecha, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->reg_fallas_tecnicas_fecha = str_replace('<', '&lt;', $this->reg_fallas_tecnicas_fecha);
          $this->reg_fallas_tecnicas_fecha = str_replace('>', '&gt;', $this->reg_fallas_tecnicas_fecha);
         $this->texto_tag .= "<td>" . $this->reg_fallas_tecnicas_fecha . "</td>\r\n";
   }
   //----- cat_fallas_tecnicas_descripcion
   function NM_export_cat_fallas_tecnicas_descripcion()
   {
         if (!NM_is_utf8($this->cat_fallas_tecnicas_descripcion))
         {
             $this->cat_fallas_tecnicas_descripcion = mb_convert_encoding($this->cat_fallas_tecnicas_descripcion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->cat_fallas_tecnicas_descripcion = str_replace('<', '&lt;', $this->cat_fallas_tecnicas_descripcion);
          $this->cat_fallas_tecnicas_descripcion = str_replace('>', '&gt;', $this->cat_fallas_tecnicas_descripcion);
         $this->texto_tag .= "<td>" . $this->cat_fallas_tecnicas_descripcion . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_fallas_tecnicas']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_fallas_tecnicas']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
