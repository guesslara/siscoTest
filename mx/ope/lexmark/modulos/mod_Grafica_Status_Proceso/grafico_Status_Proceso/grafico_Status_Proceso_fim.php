...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_Status_Proceso"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_Status_Proceso"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_Status_Proceso']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grafico_Status_Proceso']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_Status_Proceso']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grafico_Status_Proceso']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grafico_Status_Proceso']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grafico_Status_Proceso</TITLE>
