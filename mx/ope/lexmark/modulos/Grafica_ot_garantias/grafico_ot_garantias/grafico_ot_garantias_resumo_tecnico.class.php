...
class grafico_ot_garantias_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grafico_ot_garantias_resumo($tipo = "")
   {
      ...
      $this->array_total_garantia = array();
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['contr_total_geral'] == "OK")
      {
          $this->array_total_garantia = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['arr_total']['garantia'];
      }
      else
      {
          $this->array_total_garantia = array();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['arr_total']['garantia'] = $this->array_total_garantia;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['contr_array_resumo'] = "OK";
   ...
   function completeMatrix()
   {
       ...
       //-----
       foreach ($this->array_total_garantia as $i_garantia => $d_garantia) {
           if (!in_array($i_garantia, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_garantia[2] ] = $d_garantia[1];
               $this->comp_label[0][ $d_garantia[2] ] = $d_garantia[1];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_garantia => $l_garantia) {
           if (isset($this->array_total_garantia[$i_garantia])) {
               $this->comp_group[$i_garantia] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_garantia;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               'title'    => $this->getChartText("Gráfica de Ot's con y sin Garantía"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("(0) Sin Garantía                                     (1) Con Garantía"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grafico_ot_garantias_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grafico_ot_garantias_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "grafico_ot_garantias_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] = "print";
      ...
      $this->total   = new grafico_ot_garantias_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_tecnico("res", $this->array_total_garantia);
      ksort($this->array_total_garantia);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['doc_word'])
{
      ...
      $sFusionChartModule = grafico_ot_garantias_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = grafico_ot_garantias_grafico::getChartModule('Bar');
      }
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grafico_ot_garantias_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grafico_ot_garantias_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grafico_ot_garantias_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['num_css'] . '.css');
     ...
     else
     {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grafico_ot_garantias/grafico_ot_garantias_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on")
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grafico_ot_garantias/grafico_ot_garantias_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grafico_ot_garantias/grafico_ot_garantias_config_graf_flash.php?nome_apl=grafico_ot_garantias&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'grafico_ot_garantias_config_pivot.php?nome_apl=grafico_ot_garantias&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grafico_ot_garantias/grafico_ot_garantias_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grafico_ot_garantias/grafico_ot_garantias_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grafico_ot_garantias_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grafico_ot_garantias_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['campos_busca']['id']; 
          $tmp_pos = strpos($id, "##@@");
          if ($tmp_pos !== false)
          {
              $id = substr($id, 0, $tmp_pos);
          }
          $ot = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['campos_busca']['ot']; 
          $tmp_pos = strpos($ot, "##@@");
          if ($tmp_pos !== false)
          {
              $ot = substr($ot, 0, $tmp_pos);
          }
          $idp = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['campos_busca']['idp']; 
          $tmp_pos = strpos($idp, "##@@");
          if ($tmp_pos !== false)
          {
              $idp = substr($idp, 0, $tmp_pos);
          }
          $nserie = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['campos_busca']['nserie']; 
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['graf_total'] = $this->array_total_garantia;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      ksort($this->array_total_garantia);
      if (isset($this->array_total_garantia))
      {
         foreach ($this->array_total_garantia as $campo_garantia => $dados_garantia)
         {
            $campo_titulo = $campo_garantia;
            $this->quant_colunas++;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['embutida'])
      {
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      if (isset($this->array_total_garantia))
      {
         ...
         if (isset($this->array_total_garantia))
         {
             ...
             {
                 $col++;
                 $this->conv_col[$campo_garantia] = $col;
                 $this->array_garantia[$col] = $dados_garantia[3];
             }
      } // isset garantia
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_ot_garantias']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   //---- 
   function adiciona_registro($quebra_garantia, $quebra_garantia_orig)
   {
      $quebra_garantia = $quebra_garantia;
      //----- Garantia
      if (!isset($this->array_total_garantia[$quebra_garantia_orig]))
      {
         $this->array_total_garantia[$quebra_garantia_orig][0] = 1;
         $this->array_total_garantia[$quebra_garantia_orig][1] = $quebra_garantia;
         $this->array_total_garantia[$quebra_garantia_orig][2] = $quebra_garantia_orig;
      }
      else
      {
         $this->array_total_garantia[$quebra_garantia_orig][0]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->garantia_orig = $this->garantia;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->garantia, $this->garantia_orig);
            }
   }
//
