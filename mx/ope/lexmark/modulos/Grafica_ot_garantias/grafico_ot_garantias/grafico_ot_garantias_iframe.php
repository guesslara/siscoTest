...
$oExportPdf = new grafico_ot_garantias_export_pdf;
$oExportPdf->exportPdf();

class grafico_ot_garantias_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grafico_ot_garantias_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grafico_ot_garantias']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grafico_ot_garantias']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grafico_ot_garantias.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grafico_ot_garantias']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grafico_ot_garantias']['pdf_name'] : "grafico_ot_garantias.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
