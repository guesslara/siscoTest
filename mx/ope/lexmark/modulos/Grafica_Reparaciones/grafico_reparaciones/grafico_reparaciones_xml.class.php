...
class grafico_reparaciones_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grafico_reparaciones_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grafico_reparaciones.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_reparaciones']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_reparaciones']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_reparaciones']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_reparaciones']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grafico_reparaciones";
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->cat_reparaciones_descripcion))
         {
             $this->cat_reparaciones_descripcion = mb_convert_encoding($this->cat_reparaciones_descripcion, "UTF-8");
         }
         $this->xml_registro .= " cat_reparaciones_descripcion =\"" . $this->trata_dados($this->cat_reparaciones_descripcion) . "\"";
   }
   ...
   function NM_export_reg_rep_efectuadas_fecha()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->reg_rep_efectuadas_fecha))
         {
             $this->reg_rep_efectuadas_fecha = mb_convert_encoding($this->reg_rep_efectuadas_fecha, "UTF-8");
         }
         $this->xml_registro .= " reg_rep_efectuadas_fecha =\"" . $this->trata_dados($this->reg_rep_efectuadas_fecha) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_reparaciones']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_reparaciones']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
