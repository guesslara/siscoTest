...
class grafico_refacciones_rtf
{
   ...
   //---- 
   function grafico_refacciones_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grafico_refacciones.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_refacciones']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_refacciones']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_refacciones']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_refacciones']['rtf_name']);
      }
      ...
      { 
          ...
          if ($Cada_col == "reg_consumo_prods_fecha" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "cat_refacciones_descripcion" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
   ...
   function NM_export_reg_consumo_prods_fecha()
   {
         ...
         if (!NM_is_utf8($this->reg_consumo_prods_fecha))
         {
             $this->reg_consumo_prods_fecha = mb_convert_encoding($this->reg_consumo_prods_fecha, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->reg_consumo_prods_fecha = str_replace('<', '&lt;', $this->reg_consumo_prods_fecha);
          $this->reg_consumo_prods_fecha = str_replace('>', '&gt;', $this->reg_consumo_prods_fecha);
         $this->texto_tag .= "<td>" . $this->reg_consumo_prods_fecha . "</td>\r\n";
   }
   //----- cat_refacciones_descripcion
   function NM_export_cat_refacciones_descripcion()
   {
         if (!NM_is_utf8($this->cat_refacciones_descripcion))
         {
             $this->cat_refacciones_descripcion = mb_convert_encoding($this->cat_refacciones_descripcion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->cat_refacciones_descripcion = str_replace('<', '&lt;', $this->cat_refacciones_descripcion);
          $this->cat_refacciones_descripcion = str_replace('>', '&gt;', $this->cat_refacciones_descripcion);
         $this->texto_tag .= "<td>" . $this->cat_refacciones_descripcion . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_refacciones']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_refacciones']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
