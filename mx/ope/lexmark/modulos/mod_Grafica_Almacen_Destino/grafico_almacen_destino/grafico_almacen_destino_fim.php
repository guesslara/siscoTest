...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_almacen_destino"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_almacen_destino"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_almacen_destino']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grafico_almacen_destino']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_almacen_destino']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grafico_almacen_destino']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grafico_almacen_destino']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grafico_almacen_destino</TITLE>
