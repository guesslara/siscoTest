<?php
   ...
   session_start();
    $Ord_Cmp = new grafico_produccionTecnicos_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grafico_produccionTecnicos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_ger_campos['idp'] = "on";
   $tab_def_campos['idp'] = "idp";
   $tab_converte["idp"]   = "idp";
   $tab_ger_campos['nserie'] = "on";
   $tab_def_campos['nserie'] = "nserie";
   $tab_converte["nserie"]   = "nserie";
   $tab_ger_campos['f_recibo'] = "on";
   $tab_def_campos['f_recibo'] = "f_recibo";
   $tab_converte["f_recibo"]   = "f_recibo";
   $tab_ger_campos['cod_refac'] = "on";
   $tab_def_campos['cod_refac'] = "cod_refac";
   $tab_converte["cod_refac"]   = "cod_refac";
   $tab_ger_campos['cod_diag'] = "on";
   $tab_def_campos['cod_diag'] = "cod_diag";
   $tab_converte["cod_diag"]   = "cod_diag";
   $tab_ger_campos['cod_rep'] = "on";
   $tab_def_campos['cod_rep'] = "cod_rep";
   $tab_converte["cod_rep"]   = "cod_rep";
   $tab_ger_campos['obs_rep'] = "on";
   $tab_def_campos['obs_rep'] = "obs_rep";
   $tab_converte["obs_rep"]   = "obs_rep";
   $tab_ger_campos['fecha_inicio'] = "on";
   $tab_def_campos['fecha_inicio'] = "fecha_inicio";
   $tab_converte["fecha_inicio"]   = "fecha_inicio";
   $tab_ger_campos['fecha_fin'] = "on";
   $tab_def_campos['fecha_fin'] = "fecha_fin";
   $tab_converte["fecha_fin"]   = "fecha_fin";
   $tab_ger_campos['fecha_fin_rep'] = "on";
   $tab_def_campos['fecha_fin_rep'] = "fecha_fin_rep";
   $tab_converte["fecha_fin_rep"]   = "fecha_fin_rep";
   $tab_ger_campos['num_no_ok'] = "on";
   $tab_def_campos['num_no_ok'] = "num_no_ok";
   $tab_converte["num_no_ok"]   = "num_no_ok";
   $tab_ger_campos['garantia'] = "on";
   $tab_def_campos['garantia'] = "garantia";
   $tab_converte["garantia"]   = "garantia";
   $tab_ger_campos['status_proceso'] = "on";
   $tab_def_campos['status_proceso'] = "status_proceso";
   $tab_converte["status_proceso"]   = "status_proceso";
   $tab_ger_campos['status_cliente'] = "on";
   $tab_def_campos['status_cliente'] = "status_cliente";
   $tab_converte["status_cliente"]   = "status_cliente";
   $tab_ger_campos['repara'] = "on";
   $tab_def_campos['repara'] = "repara";
   $tab_converte["repara"]   = "repara";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_select'][$campo] = $ordem;
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (isset($_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['grafico_produccionTecnicos']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
