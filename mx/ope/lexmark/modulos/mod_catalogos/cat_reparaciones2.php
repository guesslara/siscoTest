<?php 
	...
	if ($a=="elegir_productos2"){
		$idd=$_POST["idd"];
			        $diagno="SELECT descripcion FROM cat_reparaciones WHERE id=$idd ";
		...
		<div align="center" id="div_datos1">
			...
			Se Agregar&aacute; la Reparaci&oacute;n #: <input type="text" name="num" id="num" value="<?php echo $idd ; ?>" size="1" readonly="1" />
