...
<script language="javascript">
	...
	function coloca_productos2(idd){
		...
		if (confirm("¿Desea guardar los cambio realizados en el Diagnostico"+idd+"?")){
			$.ajax({
				async:true,
				type: "POST",
				dataType: "html",
	...
	function guardar(){
		...
		//alert(url);
		if(confirm("¿Desea guardar el Diagnostico?")){
			$.ajax({
				async:true,
				type: "POST",
				dataType: "html",
