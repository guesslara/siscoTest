...
<title>Catalogo de Fallas Tecnicas</title>
...
<script language="javascript">
	...
	function coloca_productos2(idd){
		...
		if (confirm("¿Desea guardar los cambio realizados en la Falla Tecnica "+idd+"?")){
			$.ajax({
				async:true,
				type: "POST",
				dataType: "html",
	...
	function guardar(){
		...
		if (c==""||c=="undefined"||c==null||d==""||d=="undefined"||d==null||p==""||p=="undefined"||p==null){ 
			$("#mensajeX").html("Error: Por favor no omita los campos: Clave, Descripcion y Aplica a los Productos.");
		...
		//alert(url);
		if(confirm("¿Desea guardar la Falla Tecnica?")){
			$.ajax({
				async:true,
				type: "POST",
				dataType: "html",
...
<div id="div_nuevo" style="width: 50%;">
	<div class="div_nuevoA" id="div_nuevoA" style="width: 60%;">&nbsp;Nueva Falla Tecnica.</div>
