...
<title>Catalogo de Pruebas Esteticas</title>
...
<script language="javascript">
	...
	function start(){
		...
		$.ajax({
			...
			url:"cat_pruebas_esteticas2.php",
			data:"action=listar",
			beforeSend:function(){ 
	...
	function coloca_productos2(idd){
		...
		if (confirm("¿Desea guardar los cambio realizados en la Prueba Estetica "+idd+"?")){
			$.ajax({
				async:true,
				type: "POST",
				dataType: "html",
	...
	function guardar(){
		...
		//alert(url);
		if(confirm("¿Desea guardar la Prueba Estetica?")){
			$.ajax({
				async:true,
				type: "POST",
				dataType: "html",
...
<div id="div_nuevo" style="width: 50%;">
	<div class="div_nuevoA" id="div_nuevoA" style="width: 60%;">&nbsp;Nueva Prueba Estetica.</div>
