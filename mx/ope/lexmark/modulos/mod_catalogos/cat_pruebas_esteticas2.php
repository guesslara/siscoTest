<?php 
	...
	if ($a=="elegir_productos"){
		...
		<br /><table align="center" width="739" style="font-weight:bold; font-size:12px;">
			<tr>
			  <td colspan="5" align="center">La Prueba Est&eacute;tica aplica a los productos seleccionados. </td>
		  </tr>
			<tr>
			  <td>&nbsp;</td>
			  <td>Id</td>
	...
	if ($a=="elegir_productos2"){
		$idd=$_POST["idd"];
		$diagno="SELECT descripcion FROM cat_pruebas_esteticas WHERE id=$idd ";
		...
		<div align="center" id="div_datos1">
			...
			Se Agregar&aacute; la Prueba Est&eacute;tica #: <input type="text" name="num" id="num" value="<?php echo $idd ; ?>" size="1" readonly="1" />
	...
	if ($a=="listar"){	
		//echo "<br>BD [$sql_ing] SQL=".
		$sql1="SELECT * FROM cat_pruebas_esteticas ORDER BY id";
...
<script language="javascript"> $("#all").show(); </script>
			...
			echo "<div align=center><br><br>Error SQL. La consulta a la Base de Datos no se ejecuto.</div>";
			exit();
		}
	}	
?>