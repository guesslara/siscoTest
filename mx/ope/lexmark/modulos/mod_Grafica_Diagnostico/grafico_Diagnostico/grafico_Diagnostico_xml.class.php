...
class grafico_Diagnostico_xml
{
   ...
   //---- 
   function grafico_Diagnostico_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grafico_Diagnostico.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grafico_Diagnostico";
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->cat_diagnosticos_diagnostico))
         {
             $this->cat_diagnosticos_diagnostico = mb_convert_encoding($this->cat_diagnosticos_diagnostico, "UTF-8");
         }
         $this->xml_registro .= " cat_diagnosticos_diagnostico =\"" . $this->trata_dados($this->cat_diagnosticos_diagnostico) . "\"";
   }
   //----- sc_field_0
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
