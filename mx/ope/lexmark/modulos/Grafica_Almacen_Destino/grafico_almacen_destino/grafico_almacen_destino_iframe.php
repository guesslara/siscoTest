...
$oExportPdf = new grafico_almacen_destino_export_pdf;
$oExportPdf->exportPdf();

class grafico_almacen_destino_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grafico_almacen_destino_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grafico_almacen_destino']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grafico_almacen_destino']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grafico_almacen_destino.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grafico_almacen_destino']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grafico_almacen_destino']['pdf_name'] : "grafico_almacen_destino.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
