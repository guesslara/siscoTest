<?php
   ...
   $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_doc']        = "";
//
class grafico_pruebas_esteticas_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['decimal_db'] = "."; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) == 'on') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grafico_pruebas_esteticas';
      ...
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['SC_Link_View'] = true;
          }
      }
...
<?php
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grafico_pruebas_esteticas_erro.class.php"); 
      $this->Erro = new grafico_pruebas_esteticas_erro();
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      ob_start();
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_conexao']) && $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_perfil']) && $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grafico_pruebas_esteticas']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['embutida_init']) 
      {
      }
// 
      if (isset($_SESSION['scriptcase']['glo_decimal_db']) && !empty($_SESSION['scriptcase']['glo_decimal_db']))
      {
         $_SESSION['sc_session'][$this->sc_page]['grafico_pruebas_esteticas']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
...
//===============================================================================
//
class grafico_pruebas_esteticas_sub_css
{
   function grafico_pruebas_esteticas_sub_css()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grafico_pruebas_esteticas']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grafico_pruebas_esteticas'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grafico_pruebas_esteticas_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida'])
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grafico_pruebas_esteticas($cadapar[1]);
                       $$cadapar[0] = $cadapar[1];
                   }
              }
          } 
      ...
      if (!$this->Ini) 
      { 
          $this->Ini = new grafico_pruebas_esteticas_ini(); 
          $this->Ini->init();
      } 
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_erro.class.php"); 
      } 
      $this->Erro      = new grafico_pruebas_esteticas_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_lookup.class.php"); 
      } 
      $this->Lookup       = new grafico_pruebas_esteticas_lookup();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['SC_Ind_Groupby'] = $Ind;
      } 
      $this->Ini->Apl_resumo  = "grafico_pruebas_esteticas_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grafico_pruebas_esteticas_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_res'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = 'pdf';
          $nmgp_opcao = 'pdf';
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_tipo']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_disp']        = array('Bar');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_larg']        = 800;
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_treeview'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['field_order'][] = "ot_id";
      ...
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['grafico_pruebas_esteticas']['exit'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_orig']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = "resumo" ;  
      }   
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grafico_pruebas_esteticas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grafico_pruebas_esteticas']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = "busca";
          }   
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida_form'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "busca")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = "inicio";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_all'] = true;
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq'];
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['orig_pesq'] = 'grid';
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = 'inicio';
          } 
      } 
//
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq_filtro'];
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
      {
         ...
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grafico_pruebas_esteticas_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_grafico_pruebas_esteticas.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grafico_pruebas_esteticas_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->java_protocol . $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grafico_pruebas_esteticas_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          $nm_arquivo_doc_word = "/sc_grafico_pruebas_esteticas_res_" . session_id() . ".doc";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_xls.class.php"); 
          } 
          $this->xls  = new grafico_pruebas_esteticas_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_xml.class.php"); 
          } 
          $this->xml  = new grafico_pruebas_esteticas_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_csv.class.php"); 
          } 
          $this->csv  = new grafico_pruebas_esteticas_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_rtf.class.php"); 
          } 
          $this->rtf  = new grafico_pruebas_esteticas_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grafico_pruebas_esteticas . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
          ...
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'], 8));
          }
          else
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "busca")  
      { 
          require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_pesq.class.php"); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq'];  
          $this->pesq  = new grafico_pruebas_esteticas_pesq();
          $this->prep_modulos("pesq");
          $this->pesq->monta_busca();
      }
      else 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "resumo" || $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "pesq")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grafico_pruebas_esteticas_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['doc_word']  = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao']     = "pdf";
              $_SESSION['scriptcase']['saida_word'] = true;
              $nm_arquivo_doc_word = "/sc_grafico_pruebas_esteticas_" . session_id() . ".doc";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_grid.class.php"); 
          } 
          $this->grid  = new grafico_pruebas_esteticas_grid();
...
//--- 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_name']);
            }
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq_filtro'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_orig'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['fast_search']);
          return;
      }
      $comando = "";
      $sv_data = $data_search;
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "cat_pruebas_esteticas.descripcion", $arg_search, $data_search);
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq_filtro'] = "( " . $comando . " )";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_orig'])) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_orig'] . " and ( " . $comando . " )"; 
      }
      else
      {
          $comando = " where (" . $comando . ")"; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['fast_search'][2] = $sv_data;
   }
...
<form name="Fdown" method="get" action="grafico_pruebas_esteticas_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="nm_tit_doc" value="grafico_pruebas_esteticas.doc"> 
...
//======= =========================
   ...
   {
       include_once("grafico_pruebas_esteticas_nmutf8.php");
   }
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grafico_pruebas_esteticas($nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']);
               $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grafico_pruebas_esteticas']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grafico_pruebas_esteticas']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grafico_pruebas_esteticas']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grafico_pruebas_esteticas']['protect_modal']) && !empty($_SESSION['scriptcase']['grafico_pruebas_esteticas']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grafico_pruebas_esteticas']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        {
            $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grafico_pruebas_esteticas";
        }
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            ...
            {
                if ($nome_apl == 'grafico_pruebas_esteticas' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grafico_pruebas_esteticas/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['tot_geral']);
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grafico_pruebas_esteticas')
   {
       $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grafico_pruebas_esteticas_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['where_resumo'] = $Temp_parms;
       } 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opcao'] = $nmgp_opcao ;  
       }   
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       {
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['res_hrz'] = ($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['res_hrz']) ? false : true;
       }
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['volta_redirect_tp'] = "";
           $nm_url_saida = "grafico_pruebas_esteticas_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_modal'] = true;
               }
               $nm_url_saida = "grafico_pruebas_esteticas_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opcao'] != "pdf" ) 
       { 
            $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['menu_desenv'] = true;   
       } 
       if (isset($_GET["nmgp_parms_ret"])) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opc_psq'] = true ;   
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opc_psq'] = false ;   
       } 
       if ($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida_form'])
       {
           $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['mostra_edit'] = "N";   
       ...
       $contr_grafico_pruebas_esteticas = new grafico_pruebas_esteticas_apl();
       $contr_grafico_pruebas_esteticas->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grafico_pruebas_esteticas(&$str)
   {
