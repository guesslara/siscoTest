...
class grafico_pruebas_esteticas_resumo
{
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               'title'    => $this->getChartText("Gráfica de Pruebas estéticas"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Pruebas Estéticas"),
   ...
   function totaliza()
   {
      $this->total->resumo_tecnico("res", $this->array_total_cat_pruebas_esteticas_descripcion);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cat_pruebas_esteticas_descripcion = $rs_res->fields[12] ;  
