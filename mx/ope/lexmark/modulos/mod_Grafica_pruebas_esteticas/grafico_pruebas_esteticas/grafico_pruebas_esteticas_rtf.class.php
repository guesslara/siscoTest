...
class grafico_pruebas_esteticas_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grafico_pruebas_esteticas_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_grafico_pruebas_esteticas";
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grafico_pruebas_esteticas.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['order_grid'];
   ...
   function NM_export_cat_pruebas_esteticas_descripcion()
   {
         if (!NM_is_utf8($this->cat_pruebas_esteticas_descripcion))
         {
          ...
          $this->cat_pruebas_esteticas_descripcion = str_replace('<', '&lt;', $this->cat_pruebas_esteticas_descripcion);
          $this->cat_pruebas_esteticas_descripcion = str_replace('>', '&gt;', $this->cat_pruebas_esteticas_descripcion);
         $this->texto_tag .= "<td>" . $this->cat_pruebas_esteticas_descripcion . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
