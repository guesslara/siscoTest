...
class grafico_Diagnostico_rtf
{
   ...
   //---- 
   function grafico_Diagnostico_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_grafico_Diagnostico";
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grafico_Diagnostico.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "cat_diagnosticos_diagnostico" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->cat_diagnosticos_diagnostico = $rs->fields[6] ;  
   ...
   //----- cat_diagnosticos_diagnostico
   function NM_export_cat_diagnosticos_diagnostico()
   {
         if (!NM_is_utf8($this->cat_diagnosticos_diagnostico))
         {
             $this->cat_diagnosticos_diagnostico = mb_convert_encoding($this->cat_diagnosticos_diagnostico, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->cat_diagnosticos_diagnostico = str_replace('<', '&lt;', $this->cat_diagnosticos_diagnostico);
          $this->cat_diagnosticos_diagnostico = str_replace('>', '&gt;', $this->cat_diagnosticos_diagnostico);
         $this->texto_tag .= "<td>" . $this->cat_diagnosticos_diagnostico . "</td>\r\n";
   }
   //----- sc_field_0
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_Diagnostico']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
