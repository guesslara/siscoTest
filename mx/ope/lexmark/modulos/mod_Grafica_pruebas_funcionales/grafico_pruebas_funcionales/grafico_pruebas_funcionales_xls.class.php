...
class grafico_pruebas_funcionales_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $tit_doc;
   //---- 
   function grafico_pruebas_funcionales_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "grafico_pruebas_funcionales.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function NM_export_cat_pruebas_funcionales_descripcion()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->cat_pruebas_funcionales_descripcion);
         $this->xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['xls_file'] = $this->xls_f;
      }
?>
