...
class grafico_pruebas_funcionales_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grafico_pruebas_funcionales_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_grafico_pruebas_funcionales";
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grafico_pruebas_funcionales.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "cat_pruebas_funcionales_descripcion" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->cat_pruebas_funcionales_descripcion = $rs->fields[12] ;  
   ...
   //----- cat_pruebas_funcionales_descripcion
   function NM_export_cat_pruebas_funcionales_descripcion()
   {
         if (!NM_is_utf8($this->cat_pruebas_funcionales_descripcion))
         {
             $this->cat_pruebas_funcionales_descripcion = mb_convert_encoding($this->cat_pruebas_funcionales_descripcion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->cat_pruebas_funcionales_descripcion = str_replace('<', '&lt;', $this->cat_pruebas_funcionales_descripcion);
          $this->cat_pruebas_funcionales_descripcion = str_replace('>', '&gt;', $this->cat_pruebas_funcionales_descripcion);
         $this->texto_tag .= "<td>" . $this->cat_pruebas_funcionales_descripcion . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_funcionales']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
