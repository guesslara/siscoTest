...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_pruebas_funcionales"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_pruebas_funcionales"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_funcionales']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_funcionales']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_funcionales']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_funcionales']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_funcionales']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grafico_pruebas_funcionales</TITLE>
