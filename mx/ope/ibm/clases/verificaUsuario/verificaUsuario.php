    ...
    //include("../conexion/conexion.php");
		...
		public $passModifica="N/A";		
			...
			public function cargaArchivosClase(){
				    ...
				    .ventanaDialogo{border:1px solid #000;background-color:#FFF;height:200px;width:300px;position:absolute;left:50%;top:50%;margin-left:-150px;margin-top:-100px;-webkit-box-shadow:10px 10px 5px #CCC;-moz-box-shadow:10px 10px 5px #CCC;filter: shadow(color=#CCC, direction=135,strength=2);}
