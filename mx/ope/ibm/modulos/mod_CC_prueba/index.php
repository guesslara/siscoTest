...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			...
			<div id="Buscar" style="border:1px solid #FFF; width: 800px; height: 25px; float: right;">
			<table align="right"><tr>
			<td><font size="2"> Buscar:</font> <input type="text" name="no_x" id="no_x" size="8" onkeyup="buscaPorParametro(event);" /></td><td><select  name="opciones" id="opciones" onchange="seleccionCambia();" >
