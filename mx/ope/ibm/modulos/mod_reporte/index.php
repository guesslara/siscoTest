...
<script type="text/javascript">
	...
	$(document).ready(function(){
		//panel('<?=$proyecto;?>');
		panel('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>');
		redimensionar();		
	});	
	function redimensionar(){
		...
		$("#detalleEmpaque").css("width",(anchoDiv-10)+"px");
...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			...
			<div class="opcionesEnsamble" onclick="clean1();panel('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>')" title="panel">panel</div>
			<!--<div class="opcionesEnsamble" onclick="clean2(); panel('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>')" title="panel">panel</div>
			<!--<div class="opcionesEnsamble" onclick="consultaLotes('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>')" title="Consulta">Consultar</div>
			<div class="opcionesEnsamble" onclick="formLotes('<?=$_SESSION[$txtApp['session']['idUsuario']];?>','<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>')" title="Agrega">Agregar</div>
			<div class="opcionesEnsamble" onclick="consultaModificaLotes('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>')" title="Modifica">Modificar</div>
