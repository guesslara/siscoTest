...
<?
	...
	?>
				<tr>
				    ...
				    <td>
<?
					echo $rep="select count(*) as REP from detalle_lotes where status='Reparado' and id_lote=".$row['id_lote'];
...
?>
				    ...
				    <td>
<?
					$scrap="select count(*) as SCRAP from detalle_lotes where status='Scrap' and id_lote=".$row['id_lote'];
...
?>					<?=$SCRAP;?>
				    ...
				    <td>
<?
					$irre="select count(*) as IRRE from detalle_lotes where status='Irreparables' and id_lote=".$row['id_lote'];
				    ...
				    <td>
<?
					$pend="select count(*) as PEND from detalle_lotes where status='Pendiente' and id_lote=".$row['id_lote'];
