	...
	<div id="contenedorEnsamble3">-->
		<div id="hoja" style="width:<?=$orientacion;?>">
			<div id="headerHoja">
				<table border=2 class="TabEN" >
					<tr>
						...
						<td rowspan=2 colspan=2><n style="font-size:9px;">REVISIÓN:</n><n style="font-size:12px; font-weight:bold;">01 </n></td>
			...
			<div id="contenidoHoja" >
				...
				?>
				<div id="tablaIz" style="width:98%;float:left; height:90%;background:#fff; border:0px solid #000;padding:0px;margin:20px auto 5px 0px;">

					<table class="tab" align="center">
							<tr id="encabezado">
								<th>ITEM</th><th style="width:80px;">NO.</th><th style="width:140px;">FECHA DE INGRESO</th><th style="width:100px;">NÚMERO DE PARTE</th><th style="width:100px;">NÚMERO DE SERIE</th><th style="width:160px;">OBSERVACIONES</th>
							</tr>
							<?
							if($noReg<$pag){
							$i=1;
			...
			<div id="footHoja">
				<div id="firma1" style="with:160px;height:35px;margin: 5px 10px 5px 80px; float:left;border:0px solid #000;"><div id="linea" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;">_________________</div><div id="nombre" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;font-size:10px;"><n class="fo">ELABORÓ</n><BR>Ana Laura Galván Sánchez<br>Ejecutiva de Cuenta HP PSG</div></div>
				<div id="firma2" style="with:160px;height:35px;margin: 5px auto 5px 80px; float:left;border:0px solid #000;"><div id="linea" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;">_________________</div><div id="nombre" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;font-size:10px;"><n class="fo">REVISÓ</n><BR>Lic.Belinda Díaz Trujillo<br>Responsable del SAC</div></div>
				<div id="firma3" style="with:160px;height:35px;margin: 5px auto 5px 80px; float:left;border:0px solid #000;"><div id="linea" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;">_________________</div><div id="nombre" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;font-size:10px;"><n class="fo">AUTORIZÓ</n><BR>Lic.Humberto Galván Lassard<br>Subdirección de Operaciones</div></div>
				<br><div id="firma3" style="with:160px;height:35px;margin: 5px auto 5px 80px; float:left;border:0px solid #000;"><div id="linea" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;"><br></div><div id="nombre" style="margin:2px auto 0 auto; clear:both:width:80%;text-align:center;font-size:10px;"><n class="fo">ESTE DOCUMENYO ES DE USO EXLCUSIVO DE IQ ELECTRONICS INTERNATIONAL, S.A. DE C.V.
				QUEDA ESTRICTAMENTE PROHIBIDA SU REPRODUCCION TOTAL O PARCIAL SIN AUTORIZACION PREVIA</n></div></div><br>
			</div>
		</div>
	<!--</div>
</div>-->
