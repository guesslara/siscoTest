		...
		<div id="hoja" style="width:<?=$orientacion;?>">
			<div id="headerHoja">
				<table border=1 class="TabEN">
					<tr>
						<td rowspan=4><img width=100 src="../../img/iqe.jpeg"></td>
			...
			<div style="<?=$h?>"id="contenidoHoja">
				...
				?>
				<div id="tablaIz" style="width:70%;float:left; height:90%;background:#fff; border:0px solid #000;padding:5px;margin:5px;">
				...
				<div id="tablaDe" style="width:20%;float:right; height:90%;background:#fff; border:0px solid #000;padding:5px;margin:5px;">
