	...
	<table border=2 class="TabEN">
		<tr>
			...
			<td rowspan=2 colspan=2>
				<div style="width: 100%;">
					<div id="n" style="font-size:9px; float: left; width: 35%; text-align: right; margin-top: 2px;">
						REVISI&Oacute;N:
					</div>
					<div id="N" style="font-size:12px; font-weight:bold; float: left; width: 8%; text-align: left;">
						01
					</div>
					<div id="n" style="font-size:9px; float: left; width: 14%; text-align: right; margin-top: 2px;">
						FECHA:
					</div>
					<div id="N" style="font-size:12px; font-weight:bold; float: left; width: 43%; text-align: left;">
						08/05/13
					</div>
				</div>
			</td>
