...
<?			
		...
		public function verFormatos($idLote,$idUsuario,$idProyecto,$numPo){
	        ...
	        function insertardatos($idLot,$date,$hora,$nom,$intrr,$numparte,$foto,$coment,$firma){
			$foto="../pag_guardar_imagen/uploads/".$foto;
			$sql="INSERT INTO detalle_IQFO750306 (id_lote,fecha,hora,destinatario,introduccion,num_parte,imagenes,comentarios,elaboro) VALUES ('".$idLot."','".$date."', '".$hora."', '".$nom."', '".$intrr."', '".$numparte."', '".$foto."', '".$coment."','".$firma."')";
                        //echo"$sql";
...
?>
			...
			<script type="text/javascript">
			   ...
			   <td><b>LOTE</b></td><td><input type ="text" name = "lote" id = "lote" style="width:20px;height:20px;" value="<?="$idLot";?>" style="border:none"/></td>
			 </tr>
			</table>
			...
			<table border = "" cellpading = "0" cellspacing = "0" style=" margin: 5px 50px 10px 30px; width:631px;">
			 <tr>
			<td colspan="2" align="left" style="background-color:#F3F781; font-size: 8pt;"><b>FOTOGRAF&Iacute;AS O GR&Aacute;FICOS</b> (SI APLICA)</td></tr>                   
			 <tr><td><?="<center><img src='uploads/$foto' width=150 height=165></center>";?></td>
			 </tr>
			</table>
...
<?                        
		...
		function insertardatosdos($idLot,$date,$hora,$nom,$intrr,$numparte,$foto,$coment,$firma){
...
?>
			...
			<table border = "" cellpading = "0" cellspacing = "0" style=" margin: 5px 50px 10px 30px; width:639px;">
			 <tr>
			<td colspan="2" align="left" style="background-color:#F3F781; font-size: 8pt;"><b>FOTOGRAF&Iacute;AS O GR&Aacute;FICOS</b> (SI APLICA)</td></tr>                   
			 <tr><td style="height:180px; "><center><IMG SRC="pag_guardar_imagen/camera"></center><center><input type ="text" name = "nobre" id = "nobre"  value="Informe sin evidencia de imagen" style="border:none"/></center></td>
			 </tr>
			</table>
			<table border = "" cellpading ="0" cellspacing = "0" style=" margin: 1px 50px 0px 30px;">
			<tr>
