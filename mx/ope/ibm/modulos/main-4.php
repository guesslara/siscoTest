<?php
    ...
    $proyectoSeleccionado=$_POST["radio"];
    ...
    $_SESSION[$txtApp['session']['idProyectoSeleccionado']]=$proyectoSeleccionado;
    ...
    $proyectoSeleccionado=$objFuncionesGUI->dameNombreProyecto($proyectoSeleccionado);
...
<body>
    ...
    <div id="contenedorAppMain">
        <div id="barraHerramientasUsuario">
            <div class="estiloMensajeModulo"><? echo $txtApp['appPrincipal']['msgModulo'].": ".$proyectoSeleccionado;?> <span style="color: orange;font-weight: bold;">BETA</span></div>            
