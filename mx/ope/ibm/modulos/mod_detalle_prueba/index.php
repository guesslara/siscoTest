...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			...
			<div class="opcionesEnsamble" onclick="clean2();vercommodity()" title="Mostrar Pruebas de Commodity">Mostrar</div>	
			<div class="opcionesEnsamble" onclick="clean2();nuevaPrueba()" title="Agregar Pruebas">Agregar</div>	
			<!--<div class="opcionesEnsamble" onclick="clean2();modificapruebas()" title="Modificar Pruebas">Modificar</div>-->
			...
			<div class="opcionesEnsamble" onclick="clean2();commoditypruebas()" title="Eliminar Pruebas">Eliminar</div>
