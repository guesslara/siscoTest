...
<script type="text/javascript">
	$(document).ready(function(){
		buscaPorParametro('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>','<?=$_SESSION[$txtApp['session']['idUsuario']];?>');
		redimensionar();		
	});	
...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			...
			<!--<div class="opcionesEnsamble" ></div>-->
			<div id="Buscar" style="border:1px solid #FFF; width: 380px; height: 25px; float: left;">
			<table align="right"><tr>
			<td><font size="2"> Buscar:</font><select  name="opciones" id="opciones" onchange="seleccionCambia();" >
			<option value="undefined">Seleccione una opcion</option>
			<option value="NoParte">N° Parte</option>
			<option value="numSerie">N° de Serie</option></select></td>
			<td><input type="text" name="dato" id="dato" size="8" onkeyup="buscaPorParametro(event,'<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>','<?=$_SESSION[$txtApp['session']['idUsuario']];?>');" /></td>
			</tr></table></div>
			...
			<div id="detalleEmpaque" class="ventanaEnsambleContenido" style="font-size:8px; margin: 3px; overflow: auto; ">
			
				<div id="otro" style=" display: none;margin-top: 200px; border: 1px solid #74DF00; position: relative; width:98%; height: 100px"></div>
