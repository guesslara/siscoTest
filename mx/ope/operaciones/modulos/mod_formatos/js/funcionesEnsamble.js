...
function formatoPDF(noFormato,idLote,idUsuario,idProyectoSeleccionado){
	ajaxApp("detalleEmpaque","controladorEnsamble.php","action=formatoPDF&idLote="+idLote+"&idUsuario="+idUsuario+"&idProyectoSeleccionado="+idProyectoSeleccionado+"&noFormato="+noFormato,"POST"); 
}