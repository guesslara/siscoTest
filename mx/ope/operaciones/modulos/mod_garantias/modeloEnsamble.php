...
?>
			...
			<table border="0" cellpading="1" cellspacing="1" width="800" style="background: #FFF;">
				...
				<tr>
					<td class="tituloFormD">N&uacute;mero de Serie</td>
					<td><input type="text" name="numero_serie" id="numero_serie"  value="<?=$rowE["numero_serie"];?>"class="<?=$clase_obligaria?>" onkeyup="movimientoSerie(event)"></td>
				</tr>
...
?>
			...
			<table border="0" cellpading="1" cellspacing="1" width="800" style="background: #FFF;">
				...
				<tr>
					<td class="tituloFormD">N&uacute;mero de Serie</td>
					<td><input type="text" name="numero_serie" id="numero_serie" class="<?=$clase_obligaria?>" onkeyup="movimientoSerie(event)"></td>
				</tr>
				<tr>
					<td class="tituloFormD">Informaci&oacute;n de la Falla</td>
				...
				<tr>
					<td class="tituloFormD">Fecha de Asignaci&oacute;n</td>
					<td>
						<input type="text" name="fecha_asignacion" id="fecha_asignacion" readonly    class="<?=$clase_obligaria?>" onchange="getDias(),sumarD();">
						<input type="button" id="lanzadorB2"  value="..."   /> 
						<!-- script que define y configura el calendario-->
						<script type="text/javascript">
						    Calendar.setup({
				...
				<!--<tr>
					<td><input type="button" id="calculo" name="calculo" value="Calcular fecha compromiso" onclick="sumarD();"</td>
				</tr>-->
				<tr>
					<td class="tituloFormD">Fecha Compromiso</td>
					<td>
...
?>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="4000">
				<tr>				      
				      ...
				      <td class="estiloCelda" style="background: #FF8000;"># de Serie</td>
...
?>
				<tr class="estiloTr">				    
				    ...
				    <td class="estiloTdResultados" style="text-align: center;"><?=$si['numero_serie']?></td>
				    ...
				    <td class="estiloTdResultados" style="text-align: center; color: white; font-weight: bold; background: <?=$color?>"><?=$diasTabla?></td>
                                    ...
                                    <td class="estiloTdResultados" ><?=utf8_decode($si['nombre_cliente'])?></td>
				    <td class="estiloTdResultados" style="text-align: center; color: white; font-weight: bold; background: <?=$color?>"><?=$diasTabla?></td>
