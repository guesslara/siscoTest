...
if($divNom[3]=="|"){
	...
	print_r(mysql_fetch_array($exeLis));
	...
	<div id="contenedorEnsamble3">-->
		<div id="hoja" style="width:<?=$orientacion;?>">
			...
			<div id="contenidoHoja" >
				...
				<div id="tablaDe" style="width:25%;float:left; height:90%;background:#fff; border:0px solid #000;padding:0px;margin:0px;">
					...
					<div id="3" style="width:90%; height:50%; border:0px solid #000;clear:both;margin:5px;padding:5px;">
						...
						while($rowComm=mysql_fetch_array($exeComm)){
							/*for($rC=0;$rC<$numLis;$rC++){
								if($rowComm['desc_eng']==[])
							}*/
							while($rrow=mysql_fetch_array($exeLis)){
								//print($rowComm['desc_eng']."==".$rrow['desc_eng']."<br>");
							?><tr>
							...
							<!--</tr>--><?
								...
								if($rowComm['desc_eng']==$rrow['desc_eng']){
									...
									//print($rowComm['desc_eng']."<br>coun");
								?>
								<!--<tr>
