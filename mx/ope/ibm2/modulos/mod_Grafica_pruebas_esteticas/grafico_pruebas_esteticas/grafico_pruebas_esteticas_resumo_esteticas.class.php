...
class grafico_pruebas_esteticas_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_cat_pruebas_esteticas_descripcion;
   ...
   //---- 
   function grafico_pruebas_esteticas_resumo($tipo = "")
   {
      ...
      $this->array_total_cat_pruebas_esteticas_descripcion = array();
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['contr_total_geral'] == "OK")
      {
          $this->array_total_cat_pruebas_esteticas_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['arr_total']['cat_pruebas_esteticas_descripcion'];
      }
      else
      {
          $this->array_total_cat_pruebas_esteticas_descripcion = array();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['arr_total']['cat_pruebas_esteticas_descripcion'] = $this->array_total_cat_pruebas_esteticas_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['contr_array_resumo'] = "OK";
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_field_nm = array(
           'cat_pruebas_esteticas_descripcion' => 0,
       );
       ...
       //-----
       foreach ($this->array_total_cat_pruebas_esteticas_descripcion as $i_cat_pruebas_esteticas_descripcion => $d_cat_pruebas_esteticas_descripcion) {
           if (!in_array($i_cat_pruebas_esteticas_descripcion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_cat_pruebas_esteticas_descripcion[2] ] = $d_cat_pruebas_esteticas_descripcion[1];
               $this->comp_label[0][ $d_cat_pruebas_esteticas_descripcion[2] ] = $d_cat_pruebas_esteticas_descripcion[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'cat_pruebas_esteticas.descripcion', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_cat_pruebas_esteticas_descripcion => $l_cat_pruebas_esteticas_descripcion) {
           if (isset($this->array_total_cat_pruebas_esteticas_descripcion[$i_cat_pruebas_esteticas_descripcion])) {
               $this->comp_group[$i_cat_pruebas_esteticas_descripcion] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_cat_pruebas_esteticas_descripcion;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               'title'    => $this->getChartText("Gráfica de Pruebas Esteticas"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Pruebas esteticas"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grafico_pruebas_esteticas_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grafico_pruebas_esteticas_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "grafico_pruebas_esteticas_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] = "print";
      ...
      $this->total   = new grafico_pruebas_esteticas_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_esteticas("res", $this->array_total_cat_pruebas_esteticas_descripcion);
      ksort($this->array_total_cat_pruebas_esteticas_descripcion);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['doc_word'])
{
      ...
      $sFusionChartModule = grafico_pruebas_esteticas_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = grafico_pruebas_esteticas_grafico::getChartModule('Bar');
      }
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grafico_pruebas_esteticas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grafico_pruebas_esteticas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grafico_pruebas_esteticas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['num_css'] . '.css');
     ...
     else
     {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on")
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_config_graf_flash.php?nome_apl=grafico_pruebas_esteticas&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'grafico_pruebas_esteticas_config_pivot.php?nome_apl=grafico_pruebas_esteticas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grafico_pruebas_esteticas/grafico_pruebas_esteticas_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grafico_pruebas_esteticas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grafico_pruebas_esteticas_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
          $evaluacion_pruebas_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['campos_busca']['evaluacion_pruebas_id']; 
          $tmp_pos = strpos($evaluacion_pruebas_id, "##@@");
          if ($tmp_pos !== false)
          {
              $evaluacion_pruebas_id = substr($evaluacion_pruebas_id, 0, $tmp_pos);
          }
          $evaluacion_pruebas_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['campos_busca']['evaluacion_pruebas_fecha']; 
          $tmp_pos = strpos($evaluacion_pruebas_fecha, "##@@");
          if ($tmp_pos !== false)
          {
              $evaluacion_pruebas_fecha = substr($evaluacion_pruebas_fecha, 0, $tmp_pos);
          }
          $evaluacion_pruebas_id_ot = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['campos_busca']['evaluacion_pruebas_id_ot']; 
          $tmp_pos = strpos($evaluacion_pruebas_id_ot, "##@@");
          if ($tmp_pos !== false)
          {
              $evaluacion_pruebas_id_ot = substr($evaluacion_pruebas_id_ot, 0, $tmp_pos);
          }
          $evaluacion_pruebas_tipo_prueba = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['campos_busca']['evaluacion_pruebas_tipo_prueba']; 
          $tmp_pos = strpos($evaluacion_pruebas_tipo_prueba, "##@@");
          if ($tmp_pos !== false)
          {
              $evaluacion_pruebas_tipo_prueba = substr($evaluacion_pruebas_tipo_prueba, 0, $tmp_pos);
          }
      } 
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_total'] = $this->array_total_cat_pruebas_esteticas_descripcion;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      ksort($this->array_total_cat_pruebas_esteticas_descripcion);
      if (isset($this->array_total_cat_pruebas_esteticas_descripcion))
      {
         foreach ($this->array_total_cat_pruebas_esteticas_descripcion as $campo_cat_pruebas_esteticas_descripcion => $dados_cat_pruebas_esteticas_descripcion)
         {
            $campo_titulo = $campo_cat_pruebas_esteticas_descripcion;
            $this->quant_colunas++;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['embutida'])
      {
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      if (isset($this->array_total_cat_pruebas_esteticas_descripcion))
      {
         foreach ($this->array_total_cat_pruebas_esteticas_descripcion as $campo_cat_pruebas_esteticas_descripcion => $dados_cat_pruebas_esteticas_descripcion)
         {
         } // foreach cat_pruebas_esteticas_descripcion
      } // isset cat_pruebas_esteticas_descripcion
         if (isset($this->array_total_cat_pruebas_esteticas_descripcion))
         {
             foreach ($this->array_total_cat_pruebas_esteticas_descripcion as $campo_cat_pruebas_esteticas_descripcion => $dados_cat_pruebas_esteticas_descripcion)
             {
                 $col++;
                 $this->conv_col[$campo_cat_pruebas_esteticas_descripcion] = $col;
                 $this->array_cat_pruebas_esteticas_descripcion[$col] = $dados_cat_pruebas_esteticas_descripcion[3];
             }
      } // isset cat_pruebas_esteticas_descripcion
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   function monta_geral()
   {
      ...
      if (isset($this->array_total_cat_pruebas_esteticas_descripcion))
      {
         ...
         {
            $valores   = array();
            $valores[0] = $dados_cat_pruebas_esteticas_descripcion[0];
            $ind = 1;
            foreach ($valores as $i => $valor_campo)
            {
   ...
   //---- 
   function adiciona_registro($quebra_cat_pruebas_esteticas_descripcion, $quebra_cat_pruebas_esteticas_descripcion_orig)
   {
      $quebra_cat_pruebas_esteticas_descripcion = $quebra_cat_pruebas_esteticas_descripcion;
      //----- Descripcion
      if (!isset($this->array_total_cat_pruebas_esteticas_descripcion[$quebra_cat_pruebas_esteticas_descripcion_orig]))
      {
         $this->array_total_cat_pruebas_esteticas_descripcion[$quebra_cat_pruebas_esteticas_descripcion_orig][0] = 1;
         $this->array_total_cat_pruebas_esteticas_descripcion[$quebra_cat_pruebas_esteticas_descripcion_orig][1] = $quebra_cat_pruebas_esteticas_descripcion;
         $this->array_total_cat_pruebas_esteticas_descripcion[$quebra_cat_pruebas_esteticas_descripcion_orig][2] = $quebra_cat_pruebas_esteticas_descripcion_orig;
      }
      else
      {
         $this->array_total_cat_pruebas_esteticas_descripcion[$quebra_cat_pruebas_esteticas_descripcion_orig][0]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ot_f_recibo = $rs_res->fields[4] ;  
            $this->ot_fecha_fin = $rs_res->fields[5] ;  
            $this->ot_fecha_fin_rep = $rs_res->fields[6] ;  
            $this->usuarios_dp_nombre = $rs_res->fields[7] ;  
            $this->usuarios_dp_apaterno = $rs_res->fields[8] ;  
            ...
            $this->tipoalmacen_id_almacen = $rs_res->fields[13] ;  
            $this->cat_pruebas_esteticas_descripcion = $rs_res->fields[14] ;  
            $this->cat_pruebas_esteticas_descripcion_orig = $this->cat_pruebas_esteticas_descripcion;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cat_pruebas_esteticas_descripcion, $this->cat_pruebas_esteticas_descripcion_orig);
            }
   }
//
