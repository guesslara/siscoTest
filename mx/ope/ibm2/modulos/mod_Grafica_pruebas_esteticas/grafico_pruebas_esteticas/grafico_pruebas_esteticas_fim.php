...
//----- 
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grafico_pruebas_esteticas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grafico_pruebas_esteticas</TITLE>
