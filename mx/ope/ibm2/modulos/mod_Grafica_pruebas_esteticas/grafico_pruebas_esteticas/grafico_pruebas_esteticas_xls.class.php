...
class grafico_pruebas_esteticas_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $tit_doc;
   //---- 
   function grafico_pruebas_esteticas_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "grafico_pruebas_esteticas.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['xls_file'] = $this->xls_f;
      }
?>
