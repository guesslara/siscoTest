...
<?php
   ...
   function grafico_flash_config_div()
   {
      ...
      $sChartOrder       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_order'])     && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_order'])     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grafico_pruebas_esteticas']['graf_order']     : '';
