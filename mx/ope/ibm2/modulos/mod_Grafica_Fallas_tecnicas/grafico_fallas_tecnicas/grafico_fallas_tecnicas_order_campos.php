<?php
   ...
   session_start();
    $Ord_Cmp = new grafico_fallas_tecnicas_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grafico_fallas_tecnicas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_ger_campos['ot_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_id'] = "ot_id";
       $tab_converte["ot_id"]   = "ot_id";
   }
   else
   {
       $tab_def_campos['ot_id'] = "ot.id";
       $tab_converte["ot.id"]   = "ot_id";
   }
   $tab_ger_campos['ot_ot'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_ot'] = "ot_ot";
       $tab_converte["ot_ot"]   = "ot_ot";
   }
   else
   {
       $tab_def_campos['ot_ot'] = "ot.ot";
       $tab_converte["ot.ot"]   = "ot_ot";
   }
   $tab_ger_campos['ot_idp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_idp'] = "ot_idp";
       $tab_converte["ot_idp"]   = "ot_idp";
   }
   else
   {
       $tab_def_campos['ot_idp'] = "ot.idp";
       $tab_converte["ot.idp"]   = "ot_idp";
   }
   $tab_ger_campos['ot_nserie'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_nserie'] = "ot_nserie";
       $tab_converte["ot_nserie"]   = "ot_nserie";
   }
   else
   {
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_f_recibo'] = "ot_f_recibo";
       $tab_converte["ot_f_recibo"]   = "ot_f_recibo";
   }
   else
   {
       $tab_def_campos['ot_f_recibo'] = "ot.f_recibo";
       $tab_converte["ot.f_recibo"]   = "ot_f_recibo";
   }
   $tab_ger_campos['ot_fecha_fin'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_fecha_fin'] = "ot_fecha_fin";
       $tab_converte["ot_fecha_fin"]   = "ot_fecha_fin";
   }
   else
   {
       $tab_def_campos['ot_fecha_fin'] = "ot.fecha_fin";
       $tab_converte["ot.fecha_fin"]   = "ot_fecha_fin";
   }
   $tab_ger_campos['ot_fecha_fin_rep'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_fecha_fin_rep'] = "ot_fecha_fin_rep";
       $tab_converte["ot_fecha_fin_rep"]   = "ot_fecha_fin_rep";
   }
   else
   {
   ...
   $tab_ger_campos['ot_repara'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_repara'] = "ot_repara";
       $tab_converte["ot_repara"]   = "ot_repara";
   }
   else
   {
       $tab_def_campos['ot_repara'] = "ot.repara";
       $tab_converte["ot.repara"]   = "ot_repara";
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_status_proceso'] = "ot_status_proceso";
       $tab_converte["ot_status_proceso"]   = "ot_status_proceso";
   }
   else
   {
       $tab_def_campos['ot_status_proceso'] = "ot.status_proceso";
       $tab_converte["ot.status_proceso"]   = "ot_status_proceso";
   }
   $tab_ger_campos['ot_status_cliente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_status_cliente'] = "ot_status_cliente";
       $tab_converte["ot_status_cliente"]   = "ot_status_cliente";
   }
   else
   {
       $tab_def_campos['ot_status_cliente'] = "ot.status_cliente";
       $tab_converte["ot.status_cliente"]   = "ot_status_cliente";
   }
   $tab_ger_campos['ot_shipdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ot_shipdate'] = "ot_shipdate";
       $tab_converte["ot_shipdate"]   = "ot_shipdate";
   }
   else
   {
   ...
   $tab_ger_campos['reg_fallas_tecnicas_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['reg_fallas_tecnicas_fecha'] = "reg_fallas_tecnicas_fecha";
       $tab_converte["reg_fallas_tecnicas_fecha"]   = "reg_fallas_tecnicas_fecha";
   }
   else
   {
       $tab_def_campos['reg_fallas_tecnicas_fecha'] = "reg_fallas_tecnicas.fecha";
       $tab_converte["reg_fallas_tecnicas.fecha"]   = "reg_fallas_tecnicas_fecha";
   }
   $tab_ger_campos['cat_fallas_tecnicas_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cat_fallas_tecnicas_descripcion'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "cat_fallas_tecnicas_descripcion";
   }
   else
   {
       $tab_def_campos['cat_fallas_tecnicas_descripcion'] = "cat_fallas_tecnicas.descripcion";
       $tab_converte["cat_fallas_tecnicas.descripcion"]   = "cat_fallas_tecnicas_descripcion";
   }
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_select'][$campo] = $ordem;
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (isset($_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['grafico_fallas_tecnicas']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
