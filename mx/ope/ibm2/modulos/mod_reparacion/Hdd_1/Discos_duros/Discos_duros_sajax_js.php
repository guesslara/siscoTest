  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Discos_duros" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scAjaxGetFieldRadio(sFieldName)
  {
    ...
    if (!oFormField.length)
    {
        ...
        {
           sValue = sc_cmp_radio.value.replace(/[+]/g, "__NM_PLUS__");
        }
    }
    else
    {
  ...
  function scAjaxGetFieldEditorHtml(sFieldName)
  {
    ...
    var oFormField = tinyMCE.getInstanceById(sFieldName);
    return scAjaxSpecCharParser(oFormField.getContent().replace(/[+]/g, "__NM_PLUS__"));
  ...
  // ---------- Validate id_
  function do_ajax_Discos_duros_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Discos_duros_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_Discos_duros_validate_id__cb);
  } // do_ajax_Discos_duros_validate_id_

  function do_ajax_Discos_duros_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Discos_duros_validate_id__cb

  // ---------- Validate no_parte_
  function do_ajax_Discos_duros_validate_no_parte_(iNumLinha)
  {
    var nomeCampo_no_parte_ = "no_parte_" + iNumLinha;
    var var_no_parte_ = scAjaxGetFieldText(nomeCampo_no_parte_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Discos_duros_validate_no_parte_(var_no_parte_, iNumLinha, var_script_case_init, do_ajax_Discos_duros_validate_no_parte__cb);
  } // do_ajax_Discos_duros_validate_no_parte_

  function do_ajax_Discos_duros_validate_no_parte__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "no_parte_" + iLineNumber;
    }
    else
    {
      sFieldValid = "no_parte_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "no_parte_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "no_parte_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Discos_duros_validate_no_parte__cb

  // ---------- Validate capacidad_
  function do_ajax_Discos_duros_validate_capacidad_(iNumLinha)
  {
    var nomeCampo_capacidad_ = "capacidad_" + iNumLinha;
    var var_capacidad_ = scAjaxGetFieldText(nomeCampo_capacidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Discos_duros_validate_capacidad_(var_capacidad_, iNumLinha, var_script_case_init, do_ajax_Discos_duros_validate_capacidad__cb);
  } // do_ajax_Discos_duros_validate_capacidad_

  function do_ajax_Discos_duros_validate_capacidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "capacidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "capacidad_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "capacidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "capacidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Discos_duros_validate_capacidad__cb

  // ---------- Validate rpm_
  function do_ajax_Discos_duros_validate_rpm_(iNumLinha)
  {
    var nomeCampo_rpm_ = "rpm_" + iNumLinha;
    var var_rpm_ = scAjaxGetFieldText(nomeCampo_rpm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Discos_duros_validate_rpm_(var_rpm_, iNumLinha, var_script_case_init, do_ajax_Discos_duros_validate_rpm__cb);
  } // do_ajax_Discos_duros_validate_rpm_

  function do_ajax_Discos_duros_validate_rpm__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rpm_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rpm_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rpm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rpm_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Discos_duros_validate_rpm__cb

  // ---------- Validate interface_
  function do_ajax_Discos_duros_validate_interface_(iNumLinha)
  {
    var nomeCampo_interface_ = "interface_" + iNumLinha;
    var var_interface_ = scAjaxGetFieldText(nomeCampo_interface_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Discos_duros_validate_interface_(var_interface_, iNumLinha, var_script_case_init, do_ajax_Discos_duros_validate_interface__cb);
  } // do_ajax_Discos_duros_validate_interface_

  function do_ajax_Discos_duros_validate_interface__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "interface_" + iLineNumber;
    }
    else
    {
      sFieldValid = "interface_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "interface_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "interface_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Discos_duros_validate_interface__cb

  // ---------- Validate pulgada_
  function do_ajax_Discos_duros_validate_pulgada_(iNumLinha)
  {
    var nomeCampo_pulgada_ = "pulgada_" + iNumLinha;
    var var_pulgada_ = scAjaxGetFieldText(nomeCampo_pulgada_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Discos_duros_validate_pulgada_(var_pulgada_, iNumLinha, var_script_case_init, do_ajax_Discos_duros_validate_pulgada__cb);
  } // do_ajax_Discos_duros_validate_pulgada_

  function do_ajax_Discos_duros_validate_pulgada__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pulgada_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pulgada_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pulgada_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pulgada_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Discos_duros_validate_pulgada__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_Discos_duros_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_Discos_duros_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Discos_duros_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_Discos_duros_add_new_line_cb);
  } // do_ajax_Discos_duros_add_new_line

  function do_ajax_Discos_duros_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_Discos_duros_add_new_line_cb

  // ---------- backup_line
  function do_ajax_Discos_duros_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Discos_duros_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_Discos_duros_backup_line_cb);
  } // do_ajax_Discos_duros_backup_line

  function do_ajax_Discos_duros_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_Discos_duros_backup_line_cb

  function do_ajax_Discos_duros_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_Discos_duros_cancel_insert

  function do_ajax_Discos_duros_cancel_update(iSeqVert)
  {
    do_ajax_Discos_duros_backup_line(iSeqVert);
...
?>
  } // do_ajax_Discos_duros_cancel_update

  function do_ajax_Discos_duros_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_Discos_duros_restore_buttons

  // ---------- table_refresh
  function do_ajax_Discos_duros_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_Discos_duros_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_Discos_duros_table_refresh_cb);
  } //  do_ajax_Discos_duros_table_refresh

  function do_ajax_Discos_duros_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_Discos_duros_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_Discos_duros_submit_form(iNumLinha, indexTR)
  {
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_no_parte_ = scAjaxGetFieldText("no_parte_" + iNumLinha);
    var var_capacidad_ = scAjaxGetFieldText("capacidad_" + iNumLinha);
    var var_rpm_ = scAjaxGetFieldText("rpm_" + iNumLinha);
    var var_interface_ = scAjaxGetFieldText("interface_" + iNumLinha);
    var var_pulgada_ = scAjaxGetFieldText("pulgada_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_Discos_duros_submit_form(var_id_, var_no_parte_, var_capacidad_, var_rpm_, var_interface_, var_pulgada_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_Discos_duros_submit_form_cb);
  } // do_ajax_Discos_duros_submit_form

  function do_ajax_Discos_duros_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("no_parte_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("capacidad_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rpm_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("interface_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pulgada_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_Discos_duros_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_Discos_duros_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_Discos_duros_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("no_parte_" + iNavForm);
      scAjaxHideErrorDisplay("capacidad_" + iNavForm);
      scAjaxHideErrorDisplay("rpm_" + iNavForm);
      scAjaxHideErrorDisplay("interface_" + iNavForm);
      scAjaxHideErrorDisplay("pulgada_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_Discos_duros_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_Discos_duros_navigate_form_cb);
  } // do_ajax_Discos_duros_navigate_form

  function do_ajax_Discos_duros_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_Discos_duros_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "no_parte_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "capacidad_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rpm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "interface_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pulgada_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["no_parte_" + iNumLinha] = {"label": "No Parte<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["capacidad_" + iNumLinha] = {"label": "Capacidad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rpm_" + iNumLinha] = {"label": "Rpm<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["interface_" + iNumLinha] = {"label": "Interface<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pulgada_" + iNumLinha] = {"label": "Pulgada<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["no_parte_"][iNumLinha] = "no_parte_" + iNumLinha;
    ajax_field_mult["capacidad_"][iNumLinha] = "capacidad_" + iNumLinha;
    ajax_field_mult["rpm_"][iNumLinha] = "rpm_" + iNumLinha;
    ajax_field_mult["interface_"][iNumLinha] = "interface_" + iNumLinha;
    ajax_field_mult["pulgada_"][iNumLinha] = "pulgada_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["no_parte_" + iNumLinha] = new Array("hidden_field_label_no_parte_", "hidden_field_data_no_parte_" + iNumLinha);
    ajax_field_id["capacidad_" + iNumLinha] = new Array("hidden_field_label_capacidad_", "hidden_field_data_capacidad_" + iNumLinha);
    ajax_field_id["rpm_" + iNumLinha] = new Array("hidden_field_label_rpm_", "hidden_field_data_rpm_" + iNumLinha);
    ajax_field_id["interface_" + iNumLinha] = new Array("hidden_field_label_interface_", "hidden_field_data_interface_" + iNumLinha);
    ajax_field_id["pulgada_" + iNumLinha] = new Array("hidden_field_label_pulgada_", "hidden_field_data_pulgada_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["no_parte_" + iNumLinha] = "off";
    ajax_error_count["capacidad_" + iNumLinha] = "off";
    ajax_error_count["rpm_" + iNumLinha] = "off";
    ajax_error_count["interface_" + iNumLinha] = "off";
    ajax_error_count["pulgada_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["no_parte_" + iNumLinha] = "off";
    ajax_read_only["capacidad_" + iNumLinha] = "off";
    ajax_read_only["rpm_" + iNumLinha] = "off";
    ajax_read_only["interface_" + iNumLinha] = "off";
    ajax_read_only["pulgada_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["no_parte_" + iNumLinha] = "on";
    ajax_read_only["capacidad_" + iNumLinha] = "on";
    ajax_read_only["rpm_" + iNumLinha] = "on";
    ajax_read_only["interface_" + iNumLinha] = "on";
    ajax_read_only["pulgada_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["no_parte_" + iNumLinha] = null;
    ajax_error_list["capacidad_" + iNumLinha] = null;
    ajax_error_list["rpm_" + iNumLinha] = null;
    ajax_error_list["interface_" + iNumLinha] = null;
    ajax_error_list["pulgada_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_": new Array(),
    "no_parte_": new Array(),
    "capacidad_": new Array(),
    "rpm_": new Array(),
    "interface_": new Array(),
    "pulgada_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["no_parte_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["no_parte_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["no_parte_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["no_parte_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["no_parte_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["capacidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["capacidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["capacidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["capacidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["capacidad_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rpm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rpm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rpm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rpm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rpm_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["interface_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["interface_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["interface_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["interface_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["interface_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pulgada_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pulgada_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pulgada_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pulgada_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pulgada_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['no_parte_'])) ? $this->nmgp_cmp_readonly['no_parte_'] : 'off';
?>
    scAjaxFieldRead("no_parte_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['capacidad_'])) ? $this->nmgp_cmp_readonly['capacidad_'] : 'off';
?>
    scAjaxFieldRead("capacidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rpm_'])) ? $this->nmgp_cmp_readonly['rpm_'] : 'off';
?>
    scAjaxFieldRead("rpm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['interface_'])) ? $this->nmgp_cmp_readonly['interface_'] : 'off';
?>
    scAjaxFieldRead("interface_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pulgada_'])) ? $this->nmgp_cmp_readonly['pulgada_'] : 'off';
?>
    scAjaxFieldRead("pulgada_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("no_parte_" + iSeq, "on");
    scAjaxFieldRead("capacidad_" + iSeq, "on");
    scAjaxFieldRead("rpm_" + iSeq, "on");
    scAjaxFieldRead("interface_" + iSeq, "on");
    scAjaxFieldRead("pulgada_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["no_parte_" + iRow] || "on" == ajax_error_count["capacidad_" + iRow] || "on" == ajax_error_count["rpm_" + iRow] || "on" == ajax_error_count["interface_" + iRow] || "on" == ajax_error_count["pulgada_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_no_parte_" + iRow))
        document.getElementById("hidden_field_data_no_parte_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_capacidad_" + iRow))
        document.getElementById("hidden_field_data_capacidad_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_rpm_" + iRow))
        document.getElementById("hidden_field_data_rpm_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_interface_" + iRow))
        document.getElementById("hidden_field_data_interface_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_pulgada_" + iRow))
        document.getElementById("hidden_field_data_pulgada_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["no_parte_" + iRow] && "off" == ajax_error_count["capacidad_" + iRow] && "off" == ajax_error_count["rpm_" + iRow] && "off" == ajax_error_count["interface_" + iRow] && "off" == ajax_error_count["pulgada_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["no_parte_" + iRow] = "off";
        ajax_error_count["capacidad_" + iRow] = "off";
        ajax_error_count["rpm_" + iRow] = "off";
        ajax_error_count["interface_" + iRow] = "off";
        ajax_error_count["pulgada_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_no_parte_" + iRow))
        document.getElementById("hidden_field_data_no_parte_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_capacidad_" + iRow))
        document.getElementById("hidden_field_data_capacidad_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_rpm_" + iRow))
        document.getElementById("hidden_field_data_rpm_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_interface_" + iRow))
        document.getElementById("hidden_field_data_interface_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_pulgada_" + iRow))
        document.getElementById("hidden_field_data_pulgada_" + iRow).className = sCssLine;
    }
  }
