...
$old_error_handler = set_error_handler("Discos_duros_inline_scriptcase_error_handler");

function Discos_duros_inline_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Discos_duros_inline']['contr_erro']) && $_SESSION['scriptcase']['Discos_duros_inline']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Discos_duros_inline->contr_Discos_duros_inline->Apl_com_erro = true;
            if ($inicial_Discos_duros_inline->contr_Discos_duros_inline->NM_ajax_flag)
            {
                $inicial_Discos_duros_inline->contr_Discos_duros_inline->NM_ajax_info['errList']['geral_Discos_duros_inline'][] = $msg;
                return;
            }
            Discos_duros_inline_scriptcase_error_display($msg, $err_no);
        }
...
function Discos_duros_inline_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Discos_duros_inline'])  && '' != $_SESSION['scriptcase']['error_icon']['Discos_duros_inline'])  ? $_SESSION['scriptcase']['error_icon']['Discos_duros_inline']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Discos_duros_inline']) && '' != $_SESSION['scriptcase']['error_close']['Discos_duros_inline']) ? $_SESSION['scriptcase']['error_close']['Discos_duros_inline'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Discos_duros_inline']) && '' != $_SESSION['scriptcase']['error_span_title']['Discos_duros_inline']) ? $_SESSION['scriptcase']['error_span_title']['Discos_duros_inline'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Discos_duros_inline']) && '' != $_SESSION['scriptcase']['error_icon_title']['Discos_duros_inline']) ? $_SESSION['scriptcase']['error_icon_title']['Discos_duros_inline'] : '';
?>
