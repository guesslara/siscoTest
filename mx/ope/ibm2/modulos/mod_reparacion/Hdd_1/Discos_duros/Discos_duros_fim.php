...
//----- 
   ...
   unset($_SESSION['sc_session'][$script_case_init]['Discos_duros']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['Discos_duros']['sc_redir_insert']);
   unset($_SESSION['sc_session'][$script_case_init]['Discos_duros']['sc_max_reg']);
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Discos_duros']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Discos_duros']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Discos_duros']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Discos_duros']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Discos_duros']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['Discos_duros']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['Discos_duros']['db_changed'])
           {
