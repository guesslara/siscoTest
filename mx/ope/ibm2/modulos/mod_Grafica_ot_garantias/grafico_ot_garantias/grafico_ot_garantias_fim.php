...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_ot_garantias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grafico_ot_garantias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_ot_garantias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grafico_ot_garantias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grafico_ot_garantias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grafico_ot_garantias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grafico_ot_garantias']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grafico_ot_garantias</TITLE>
