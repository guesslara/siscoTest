 ...
 */
    ...
    session_start();
    $SC_apl_proc = "grafico_pruebas_funcionales";
    ...
    if (isset($_POST['bok_graf']) && $_POST['bok_graf'] == "OK")
    {
       ...
       if ($campo_apl == "nm_resumo_graf")
       {
           ...
           if (isset($_POST['barra_funil'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_barra_funil'] = $_POST['barra_funil'];
           }
           ...
           if (isset($_POST['gauge_forma'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_gauge_forma']  = $_POST['gauge_forma'];
           }
           if (isset($_POST['radar_forma'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_radar_forma']  = $_POST['radar_forma'];
           }
           if (isset($_POST['radar_empil'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_radar_empil']  = $_POST['radar_empil'];
           }
           if (isset($_POST['polar_forma'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_polar_forma']  = $_POST['polar_forma'];
           }
           if (isset($_POST['funil_dimen'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_funil_dimen']  = $_POST['funil_dimen'];
           }
           if (isset($_POST['funil_inver'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_funil_inver']  = $_POST['funil_inver'];
           }
           if (isset($_POST['pyram_dimen'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_pyram_dimen']  = $_POST['pyram_dimen'];
           }
           if (isset($_POST['pyram_valor'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_pyram_valor']  = $_POST['pyram_valor'];
           }
           if (isset($_POST['pyram_forma'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_pyram_forma']  = $_POST['pyram_forma'];
           }
       }
       else
       {
...
<?php
    ...
    elseif ($campo_apl == "nm_resumo_graf")
    {
        ...
        $barra_funil = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_barra_funil'];
        ...
        $gauge_forma = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_gauge_forma'];

        $radar_forma = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_radar_forma'];
        $radar_empil = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_radar_empil'];

        $polar_forma = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_polar_forma'];

        $funil_dimen = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_funil_dimen'];
        $funil_inver = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_funil_inver'];

        $pyram_dimen = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_pyram_dimen'];
        $pyram_valor = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_pyram_valor'];
        $pyram_forma = $_SESSION['sc_session'][$sc_page][$nome_apl] ['graf_pyram_forma'];
    }
    else
    {
