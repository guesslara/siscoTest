...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____graficoProductosPorCliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____graficoProductosPorCliente"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['graficoProductosPorCliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['graficoProductosPorCliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['graficoProductosPorCliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['graficoProductosPorCliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['graficoProductosPorCliente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>graficoProductosPorCliente</TITLE>
