<?php
   ...
   session_start();
    $Ord_Cmp = new graficoProductosPorCliente_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class graficoProductosPorCliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_def_campos['id_prod'] = "id_prod";
   $tab_converte["id_prod"]   = "id_prod";
   $tab_ger_campos['noparte'] = "on";
   $tab_def_campos['noparte'] = "noParte";
   $tab_converte["noParte"]   = "noparte";
   $tab_ger_campos['familia'] = "on";
   $tab_def_campos['familia'] = "familia";
   $tab_converte["familia"]   = "familia";
   $tab_ger_campos['subfamilia'] = "on";
   $tab_def_campos['subfamilia'] = "subfamilia";
   $tab_converte["subfamilia"]   = "subfamilia";
   $tab_ger_campos['descripgral'] = "on";
   $tab_def_campos['descripgral'] = "descripgral";
   $tab_converte["descripgral"]   = "descripgral";
   $tab_ger_campos['especificacion'] = "on";
   $tab_def_campos['especificacion'] = "especificacion";
   $tab_converte["especificacion"]   = "especificacion";
   $tab_ger_campos['unidad'] = "on";
   $tab_def_campos['unidad'] = "unidad";
   $tab_converte["unidad"]   = "unidad";
   $tab_ger_campos['control_alm'] = "on";
   $tab_def_campos['control_alm'] = "control_alm";
   $tab_converte["control_alm"]   = "control_alm";
   $tab_ger_campos['id_clientes'] = "on";
   $tab_def_campos['id_clientes'] = "id_clientes";
   $tab_converte["id_clientes"]   = "id_clientes";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_select'][$campo] = $ordem;
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (isset($_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['graficoProductosPorCliente']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
