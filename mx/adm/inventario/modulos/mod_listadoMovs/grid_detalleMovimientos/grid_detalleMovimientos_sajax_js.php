  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_detalleMovimientos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_detalleMovimientos_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_prodxmov_nummov_cond = scAjaxGetFieldSelect("prodxmov_nummov_cond");
    var var_prodxmov_nummov = scAjaxGetFieldText("prodxmov_nummov");
    var var_catprod_descripgral_cond = scAjaxGetFieldSelect("catprod_descripgral_cond");
    var var_catprod_descripgral = scAjaxGetFieldText("catprod_descripgral");
    var var_prodxmov_cantidad_cond = scAjaxGetFieldSelect("prodxmov_cantidad_cond");
    var var_prodxmov_cantidad = scAjaxGetFieldText("prodxmov_cantidad");
    var var_prodxmov_cu_cond = scAjaxGetFieldSelect("prodxmov_cu_cond");
    var var_prodxmov_cu = scAjaxGetFieldText("prodxmov_cu");
    ...
    x_grid_detalleMovimientos_ajax_save_filter( var_prodxmov_nummov_cond, var_prodxmov_nummov, var_catprod_descripgral_cond, var_catprod_descripgral, var_prodxmov_cantidad_cond, var_prodxmov_cantidad, var_prodxmov_cu_cond, var_prodxmov_cu, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_detalleMovimientos_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_detalleMovimientos_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_detalleMovimientos_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_detalleMovimientos_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_detalleMovimientos_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_detalleMovimientos_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_detalleMovimientos_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_detalleMovimientos_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_detalleMovimientos_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_detalleMovimientos_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "prodxmov_nummov";
  ajax_field_list[1] = "catprod_descripgral";
  ajax_field_list[2] = "prodxmov_cantidad";
  ajax_field_list[3] = "prodxmov_cu";

  var ajax_error_list = {
    "prodxmov_nummov": {"label": "Nummov", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "catprod_descripgral": {"label": "Descripgral", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "prodxmov_cantidad": {"label": "Cantidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "prodxmov_cu": {"label": "Cu", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
