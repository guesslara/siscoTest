...
$oExportPdf = new grid_detalleMovimientos_export_pdf;
$oExportPdf->exportPdf();

class grid_detalleMovimientos_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_detalleMovimientos_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_detalleMovimientos']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_detalleMovimientos']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_detalleMovimientos.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_detalleMovimientos']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_detalleMovimientos']['pdf_name'] : "grid_detalleMovimientos.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
