...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grid_detalleMovimientos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grid_detalleMovimientos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleMovimientos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleMovimientos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleMovimientos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleMovimientos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleMovimientos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleMovimientos</TITLE>
