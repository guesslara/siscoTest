...
class grid_mov_almacen_pesq
{
    ...
    * @access  public
    */
   function grid_mov_almacen_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      $id_mov_cond, $id_mov,
             ...
             $almacen_cond, $almacen,
             $referencia_cond, $referencia,
      $NM_filters, $NM_filters_del, $nmgp_save_name, $NM_operador, $nmgp_save_option, $bprocessa, $Ajax_label, $Ajax_val, $Campo_bi, $Opc_bi;
      $this->init();
      if (isset($this->NM_ajax_info['param']['id_mov_cond']))
      {
          $id_mov_cond = $this->NM_ajax_info['param']['id_mov_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_mov']))
      {
          $id_mov = $this->NM_ajax_info['param']['id_mov'];
      }
      ...
      if (isset($this->NM_ajax_info['param']['concepto_cond']))
      {
          $concepto_cond = $this->NM_ajax_info['param']['concepto_cond'];
      }
      if (isset($this->NM_ajax_info['param']['concepto']))
      {
          $concepto = $this->NM_ajax_info['param']['concepto'];
      }
      if (isset($this->NM_ajax_info['param']['almacen_cond']))
      {
          $almacen_cond = $this->NM_ajax_info['param']['almacen_cond'];
      }
      if (isset($this->NM_ajax_info['param']['almacen']))
      {
          $almacen = $this->NM_ajax_info['param']['almacen'];
      }
      if (isset($this->NM_ajax_info['param']['referencia_cond']))
      {
          $referencia_cond = $this->NM_ajax_info['param']['referencia_cond'];
      }
      if (isset($this->NM_ajax_info['param']['referencia']))
      {
          $referencia = $this->NM_ajax_info['param']['referencia'];
      }
      ...
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_mov_almacen_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_mov_almacen_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_mov_almacen_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_mov_almacen_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_mov_almacen_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_mov_almacen_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("grid_mov_almacen_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Movimientos Almacén</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_mov_almacen", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_mov = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['id_mov']; 
          $id_mov_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['id_mov_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_cond']; 
          $concepto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['concepto']; 
          $concepto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['concepto_cond']; 
          $almacen = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['almacen']; 
          $almacen_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['almacen_cond']; 
          $referencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['referencia']; 
          $referencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['referencia_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['NM_operador']; 
          if (strtoupper($id_mov_cond) != "II" && strtoupper($id_mov_cond) != "QP" && strtoupper($id_mov_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_mov, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_mov_cond) || empty($id_mov_cond))
      {
         $id_mov_cond = "eq";
      }
      ...
      if (!isset($almacen_cond) || empty($almacen_cond))
      {
         $almacen_cond = "eq";
      }
      if (!isset($referencia_cond) || empty($referencia_cond))
      {
         $referencia_cond = "eq";
      }
      ...
      if (!isset($id_mov) || $id_mov == "")
      {
          $id_mov = "";
      }
      if (isset($id_mov) && !empty($id_mov))
      {
         $tmp_pos = strpos($id_mov, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_mov = substr($id_mov, 0, $tmp_pos);
         }
      }
      ...
      if (isset($concepto) && !empty($concepto))
      {
         ...
         {
         $concepto = substr($concepto, 0, $tmp_pos);
         }
      }
      ...
      if (isset($almacen) && !empty($almacen))
      {
         $tmp_pos = strpos($almacen, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $almacen = substr($almacen, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($referencia, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $referencia = substr($referencia, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_mov_almacen_help.txt"))
   {
      $Arq_WebHelp = file("grid_mov_almacen_help.txt"); 
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_mov'])) ? $this->New_label['id_mov'] : "Id Mov"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="id_mov_cond">
       <OPTION value="eq" <?php if ("eq" == $id_mov_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_mov_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_mov_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $id_mov_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
 ...
 $nmgp_tab_label .= "id_mov?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_id_mov" name="id_mov" value="<?php echo NM_encode_input($id_mov) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['concepto'])) ? $this->New_label['concepto'] : "Concepto"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="concepto_cond">
       <OPTION value="eq" <?php if ("eq" == $concepto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $concepto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $concepto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $concepto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_concepto" name="concepto" value="<?php echo NM_encode_input($concepto) ?>" size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['almacen'])) ? $this->New_label['almacen'] : "Almacen"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="almacen_cond">
       <OPTION value="eq" <?php if ("eq" == $almacen_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $almacen_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $almacen_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $almacen_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "almacen?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_almacen" name="almacen" value="<?php echo NM_encode_input($almacen) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['referencia'])) ? $this->New_label['referencia'] : "Referencia"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="referencia_cond">
       <OPTION value="eq" <?php if ("eq" == $referencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $referencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $referencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $referencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "referencia?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_referencia" name="referencia" value="<?php echo NM_encode_input($referencia) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_mov_almacen']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_mov_almacen']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_mov.value = "";
   document.F1.fecha_dia.value = "";
   document.F1.fecha_mes.value = "";
   document.F1.fecha_ano.value = "";
   document.F1.concepto.value = "";
   document.F1.almacen.value = "";
   document.F1.referencia.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_mov_almacen_valida_dia(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_mov_almacen_valida_mes(this)});
 }
 function sc_grid_mov_almacen_valida_dia(obj)
 {
 ...
 function sc_grid_mov_almacen_valida_mes(obj)
 {
 ...
 function sc_grid_mov_almacen_valida_hora(obj)
 {
 ...
 function sc_grid_mov_almacen_valida_min(obj)
 {
 ...
 function sc_grid_mov_almacen_valida_seg(obj)
 {
     if (obj.value < 0 || obj.value > 59)
     {
 ...
 function sc_grid_mov_almacen_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
 ...
 function sc_grid_mov_almacen_valida_cnpj(obj)
 {
     var x         = 0;
     var y         = 5;
     var soma      = 0;
 ...
 function sc_grid_mov_almacen_valida_ciccnpj(obj)
 {
     var CnpjIn = obj.value;
     CnpjIn = CnpjIn.replace(/[.]/g, '');
     CnpjIn = CnpjIn.replace(/[-]/g, '');
     ...
     if (CnpjIn.length <= 11)
     {
         return sc_grid_mov_almacen_valida_cic(obj);
     }
     else
     {
         return sc_grid_mov_almacen_valida_cnpj(obj);
     }
 }
 function sc_grid_mov_almacen_valida_cep(obj)
 {
     var CepIn = obj.value;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Lexmark/grid_mov_almacen";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_mov_almacen']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      if (isset($nmgp_save_name) && !empty($nmgp_save_name))
      { 
          if ($id_mov_cond != "in")
          {
              nm_limpa_numero($id_mov, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $id_mov);
          ...
          $NM_temp  = (isset($id_mov_cond)) ? $id_mov_cond : ""; 
          $NM_str_filter .= "id_mov_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_mov)) ? $id_mov : ""; 
          $NM_str_filter .= "id_mov#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_temp  = (isset($concepto_cond)) ? $concepto_cond : ""; 
          $NM_str_filter .= "concepto_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($concepto)) ? $concepto : ""; 
          $NM_str_filter .= "concepto#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($almacen_cond)) ? $almacen_cond : ""; 
          $NM_str_filter .= "almacen_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($almacen)) ? $almacen : ""; 
          $NM_str_filter .= "almacen#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($referencia_cond)) ? $referencia_cond : ""; 
          $NM_str_filter .= "referencia_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($referencia)) ? $referencia : ""; 
          $NM_str_filter .= "referencia#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_mov_almacen']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['id_mov_cond'] = 'select';
      $tp_html['fecha_cond'] = 'select';
      $tp_html['concepto_cond'] = 'select';
      $tp_html['almacen_cond'] = 'select';
      $tp_html['referencia_cond'] = 'select';
      $tp_html['id_mov'] = 'text';
      $tp_html['fecha_dia'] = 'text';
      $tp_html['fecha_mes'] = 'text';
      $tp_html['fecha_ano'] = 'text';
      $tp_html['concepto'] = 'text';
      $tp_html['almacen'] = 'text';
      $tp_html['referencia'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "id_mov_cond"))
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                  }
                  if ($SC_V6 && $Cada_cmp[0] == "id_mov")
                  {
                      if (strtoupper($id_mov_cond) != "II" && strtoupper($id_mov_cond) != "QP" && strtoupper($id_mov_cond) != "IN") 
                      { 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_mov_almacen_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_mov_almacen_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $id_mov_cond, $id_mov,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano,
             $concepto_cond, $concepto,
             $almacen_cond, $almacen,
             $referencia_cond, $referencia, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $id_mov_cond_salva = $id_mov_cond; 
      if (!isset($id_mov_input_2) || $id_mov_input_2 == "")
      {
          $id_mov_input_2 = $id_mov;
      }
      ...
      $almacen_cond_salva = $almacen_cond; 
      if (!isset($almacen_input_2) || $almacen_input_2 == "")
      {
          $almacen_input_2 = $almacen;
      }
      $referencia_cond_salva = $referencia_cond; 
      if (!isset($referencia_input_2) || $referencia_input_2 == "")
      {
          $referencia_input_2 = $referencia;
      }
      if ($id_mov_cond != "in")
      {
          nm_limpa_numero($id_mov, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['id_mov'] = $id_mov; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['id_mov_cond'] = $id_mov_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['concepto'] = $concepto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['concepto_cond'] = $concepto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['almacen'] = $almacen; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['almacen_cond'] = $almacen_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['referencia'] = $referencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['referencia_cond'] = $referencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $id_mov;
      if (strtoupper($id_mov_cond) != "II" && strtoupper($id_mov_cond) != "QP" && strtoupper($id_mov_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_mov'] = $Conteudo;
      $Conteudo  = "";
      $Formato   = "";
      if (!empty($fecha_dia))
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_input_2'] = $Conteudo; 
      $Conteudo = $concepto;
      $this->cmp_formatado['concepto'] = $Conteudo;
      $Conteudo = $almacen;
      $this->cmp_formatado['almacen'] = $Conteudo;
      $Conteudo = $referencia;
      $this->cmp_formatado['referencia'] = $Conteudo;

      //----- $id_mov
      if (isset($id_mov) || $id_mov_cond == "nu" || $id_mov_cond == "nn")
      {
         $this->monta_condicao("id_mov", $id_mov_cond, $id_mov, "", "id_mov");
      }
...
//
      ...
      if (!empty($nm_psq_dt1) || $condicao == "NU" || $condicao == "NN")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha']   = trim($nm_dt_compl); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']['fecha_input_2'] = trim($nm_dt_compl_2); 
      }
      $nm_tp_dado = "";

      //----- $concepto
      if (isset($concepto) || $concepto_cond == "nu" || $concepto_cond == "nn")
      {
         $this->monta_condicao("concepmov.concepto", $concepto_cond, $concepto, "", "concepto");
      }

      //----- $almacen
      if (isset($almacen) || $almacen_cond == "nu" || $almacen_cond == "nn")
      {
         $this->monta_condicao("tipoalmacen.almacen", $almacen_cond, $almacen, "", "almacen");
      }

      //----- $referencia
      if (isset($referencia) || $referencia_cond == "nu" || $referencia_cond == "nn")
      {
         $this->monta_condicao("referencia", $referencia_cond, $referencia, "", "referencia");
      }
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['where_pesq_ant'] = $this->comando . $this->comando_fim;
