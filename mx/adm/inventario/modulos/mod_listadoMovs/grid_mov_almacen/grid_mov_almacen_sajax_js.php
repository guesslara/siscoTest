  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_mov_almacen" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_mov_almacen_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_id_mov_cond = scAjaxGetFieldSelect("id_mov_cond");
    var var_id_mov = scAjaxGetFieldText("id_mov");
    var var_fecha_cond = scAjaxGetFieldSelect("fecha_cond");
    var var_fecha_dia = scAjaxGetFieldText("fecha_dia");
    var var_fecha_mes = scAjaxGetFieldText("fecha_mes");
    var var_fecha_ano = scAjaxGetFieldText("fecha_ano");
    var var_concepto_cond = scAjaxGetFieldSelect("concepto_cond");
    var var_concepto = scAjaxGetFieldText("concepto");
    var var_almacen_cond = scAjaxGetFieldSelect("almacen_cond");
    var var_almacen = scAjaxGetFieldText("almacen");
    var var_referencia_cond = scAjaxGetFieldSelect("referencia_cond");
    ...
    x_grid_mov_almacen_ajax_save_filter( var_id_mov_cond, var_id_mov, var_fecha_cond, var_fecha_dia, var_fecha_mes, var_fecha_ano, var_concepto_cond, var_concepto, var_almacen_cond, var_almacen, var_referencia_cond, var_referencia, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_mov_almacen_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_mov_almacen_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_mov_almacen_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_mov_almacen_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_mov_almacen_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_mov_almacen_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_mov_almacen_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_mov_almacen_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_mov_almacen_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_mov_almacen_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "id_mov";
  ajax_field_list[1] = "fecha";
  ajax_field_list[2] = "concepto";
  ajax_field_list[3] = "almacen";
  ajax_field_list[4] = "referencia";

  var ajax_error_list = {
    "id_mov": {"label": "Id Mov", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "concepto": {"label": "Concepto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "almacen": {"label": "Almacen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "referencia": {"label": "Referencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
