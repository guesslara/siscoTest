...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grid_mov_almacen"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grid_mov_almacen"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mov_almacen']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mov_almacen']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mov_almacen']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mov_almacen']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mov_almacen']['sc_modal']);
