...
$oExportPdf = new grid_mov_almacen_export_pdf;
$oExportPdf->exportPdf();

class grid_mov_almacen_export_pdf {
...
<head>
 <title>Movimientos Almacén :: PDF</title>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_mov_almacen_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_mov_almacen']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_mov_almacen']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_mov_almacen.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_mov_almacen']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_mov_almacen']['pdf_name'] : "grid_mov_almacen.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
