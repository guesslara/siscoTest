...
class grid_mov_almacen_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_mov_almacen.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_mov_almacen";
   ...
   {
         nmgp_Form_Num_Val($this->id_mov, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_mov))
         {
             $this->id_mov = mb_convert_encoding($this->id_mov, "UTF-8");
         }
         $this->xml_registro .= " id_mov =\"" . $this->trata_dados($this->id_mov) . "\"";
   }
   //----- fecha
   ...
   function NM_export_concepto()
   {
         ...
         {
             $this->concepto = mb_convert_encoding($this->concepto, "UTF-8");
         }
         $this->xml_registro .= " concepto =\"" . $this->trata_dados($this->concepto) . "\"";
   }
   //----- almacen
   function NM_export_almacen()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->almacen))
         {
             $this->almacen = mb_convert_encoding($this->almacen, "UTF-8");
         }
         $this->xml_registro .= " almacen =\"" . $this->trata_dados($this->almacen) . "\"";
   }
   //----- referencia
   function NM_export_referencia()
   {
         ...
         {
             $this->referencia = mb_convert_encoding($this->referencia, "UTF-8");
         }
         $this->xml_registro .= " referencia =\"" . $this->trata_dados($this->referencia) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Movimientos Almacén :: XML</TITLE>
