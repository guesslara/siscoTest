...
class grid_mov_almacen_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_mov_almacen.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['rtf_name']);
      }
   ...
   function NM_export_id_mov()
   {
         ...
         if (!NM_is_utf8($this->id_mov))
         {
          ...
          $this->id_mov = str_replace('<', '&lt;', $this->id_mov);
          $this->id_mov = str_replace('>', '&gt;', $this->id_mov);
         $this->texto_tag .= "<td>" . $this->id_mov . "</td>\r\n";
   }
   //----- fecha
   ...
   function NM_export_almacen()
   {
         if (!NM_is_utf8($this->almacen))
         {
          ...
          $this->almacen = str_replace('<', '&lt;', $this->almacen);
          $this->almacen = str_replace('>', '&gt;', $this->almacen);
         $this->texto_tag .= "<td>" . $this->almacen . "</td>\r\n";
   }
   //----- referencia
   function NM_export_referencia()
   {
         if (!NM_is_utf8($this->referencia))
         {
          ...
          $this->referencia = str_replace('<', '&lt;', $this->referencia);
          $this->referencia = str_replace('>', '&gt;', $this->referencia);
         $this->texto_tag .= "<td>" . $this->referencia . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mov_almacen']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Movimientos Almacén :: RTF</TITLE>
