  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_numSeries" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scAjaxRecreateOptions(sFieldType, sHtmlType, sFieldName, oFieldValues, oFieldOptions, iColNum, sHtmComp, sOptComp, sOptClass, sOptMulti)
  {
    ...
    for (iRecreate = 0; iRecreate < oFieldOptions.length; iRecreate++)
    {
        ...
        sDivText += "<td class=\"scFilterFieldFontEven\">";
  ...
  // ---------- save_filter
  function grid_numSeries_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_id_cond = scAjaxGetFieldSelect("id_cond");
    var var_id = scAjaxGetFieldText("id");
    var var_serie_cond = scAjaxGetFieldSelect("serie_cond");
    var var_serie = scAjaxGetFieldText("serie");
    var var_noparte_cond = scAjaxGetFieldSelect("noparte_cond");
    var var_noparte = scAjaxGetFieldText("noparte");
    var var_status_cond = scAjaxGetFieldSelect("status_cond");
    var var_status = scAjaxGetFieldText("status");
    var var_nombrecliente_cond = scAjaxGetFieldSelect("nombrecliente_cond");
    var var_nombrecliente = scAjaxGetFieldText("nombrecliente");
    var var_almacenasociado_cond = scAjaxGetFieldSelect("almacenasociado_cond");
    var var_almacenasociado = scAjaxGetFieldText("almacenasociado");
    ...
    x_grid_numSeries_ajax_save_filter( var_id_cond, var_id, var_serie_cond, var_serie, var_noparte_cond, var_noparte, var_status_cond, var_status, var_nombrecliente_cond, var_nombrecliente, var_almacenasociado_cond, var_almacenasociado, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_numSeries_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_numSeries_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_numSeries_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_numSeries_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_numSeries_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_numSeries_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_numSeries_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_numSeries_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_numSeries_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_numSeries_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "serie";
  ajax_field_list[2] = "noparte";
  ajax_field_list[3] = "status";
  ajax_field_list[4] = "nombrecliente";
  ajax_field_list[5] = "almacenasociado";

  var ajax_error_list = {
    "id": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "serie": {"label": "Serie", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "noparte": {"label": "No Parte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "status": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "nombrecliente": {"label": "SR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "almacenasociado": {"label": "Almacen Asociado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
