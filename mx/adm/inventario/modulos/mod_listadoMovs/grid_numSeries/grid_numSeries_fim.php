...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Lexmark_____grid_numSeries"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Lexmark_____grid_numSeries"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_numSeries']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_numSeries']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_numSeries']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_numSeries']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_numSeries']['sc_modal']);
