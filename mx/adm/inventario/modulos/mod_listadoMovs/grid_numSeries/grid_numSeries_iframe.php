...
$oExportPdf = new grid_numSeries_export_pdf;
$oExportPdf->exportPdf();

class grid_numSeries_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_numSeries_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_numSeries']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_numSeries']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_numSeries.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_numSeries']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_numSeries']['pdf_name'] : "grid_numSeries.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
