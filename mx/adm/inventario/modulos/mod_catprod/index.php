...
<div id="contenedorAdmin" style="position: absolute;width: 99.5%;height: 99%;background: #CCC;border: 1px solid #000;margin: 2px;">
	<div id="contenedorIzquierdoAdmin" style="position: relative;float: left;width: 250px;height: 99%;background: #F0F0F0;margin: 2px;border: 1px solid #666;overflow: auto;">
		<div style="height: 20px;padding: 5px;background: #e1e1e1;font-weight: bold;text-align: center;">Catprod</div>
		<div style="height: 150px;padding: 5px;background: #fff;font-weight: bold;text-align: left;border: 0px solid #666;width:93%;">
			
			Buscador:
			<input type="text" name="txtBuscar" id="txtBuscar"  style="width:150px; font-size:14px; color:#000;"  /><br />
			<input type="button" id="boton" value="Buscar" onclick="Busador()"/>
		</div>
