...
$oExportPdf = new graficoProductosPorCliente_export_pdf;
$oExportPdf->exportPdf();

class graficoProductosPorCliente_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("graficoProductosPorCliente_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['graficoProductosPorCliente']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['graficoProductosPorCliente']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_graficoProductosPorCliente.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['graficoProductosPorCliente']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['graficoProductosPorCliente']['pdf_name'] : "graficoProductosPorCliente.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
